...
def update_usb_power_port_l_led_bounds_v4(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0031_update_usb_power_port_l_led_bounds_v3"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_l_led_bounds_v4),
    ]
