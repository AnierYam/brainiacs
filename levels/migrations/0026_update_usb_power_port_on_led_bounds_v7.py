...
def update_usb_power_port_on_led_bounds_v7(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0025_update_usb_power_port_on_led_bounds_v6"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v7),
    ]
