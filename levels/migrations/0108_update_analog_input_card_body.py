...
NEW_BODY = (
    "Analog input reads a range of values instead of just ON or OFF.\n\n"
    "On Arduino, analog pins (A0-A5) are used to read *sensors that change values* like Joystick, Potentiometer, Sound sensor."
)
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0107_update_analog_input_card_title"),
    ]
