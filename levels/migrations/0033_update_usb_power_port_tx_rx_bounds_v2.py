...
def update_usb_power_port_tx_rx_bounds_v2(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0032_update_usb_power_port_l_led_bounds_v4"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_tx_rx_bounds_v2),
    ]
