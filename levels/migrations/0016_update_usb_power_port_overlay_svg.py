...
def update_usb_power_port_overlay_svg(apps, schema_editor):
    ...
    payload["overlay_image"] = "/static/lessons/mission2/arduino_board_highlight_frames.svg"
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0015_update_usb_power_port_overlay_frames"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_overlay_svg),
    ]
