...
def update_usb_power_port_microcontroller_bounds_v2(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0045_update_usb_power_port_power_header_bounds_v2"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_microcontroller_bounds_v2),
    ]
