...
def update_usb_power_port_power_header_bounds_v3(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0048_update_usb_power_port_microcontroller_bounds_v4"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_power_header_bounds_v3),
    ]
