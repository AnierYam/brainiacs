...
def update_usb_power_port_on_led_bounds_v9(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0027_update_usb_power_port_on_led_bounds_v8"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v9),
    ]
