...
def update_usb_power_port_tx_rx_bounds_v6(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0036_update_usb_power_port_tx_rx_bounds_v5"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_tx_rx_bounds_v6),
    ]
