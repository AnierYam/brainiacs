...
def update_power_out_pins_card1_body_spacing(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0092_update_power_out_pins_card1_body"),
    ]

    operations = [
        migrations.RunPython(update_power_out_pins_card1_body_spacing),
    ]
