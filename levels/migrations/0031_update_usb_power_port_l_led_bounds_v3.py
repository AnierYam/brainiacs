...
def update_usb_power_port_l_led_bounds_v3(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0030_update_usb_power_port_l_led_bounds_v2"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_l_led_bounds_v3),
    ]
