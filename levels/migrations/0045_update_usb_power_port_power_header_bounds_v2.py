...
def update_usb_power_port_power_header_bounds_v2(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0044_update_usb_power_port_l_led_bounds_v10"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_power_header_bounds_v2),
    ]
