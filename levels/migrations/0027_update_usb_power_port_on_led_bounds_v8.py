...
def update_usb_power_port_on_led_bounds_v8(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0026_update_usb_power_port_on_led_bounds_v7"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v8),
    ]
