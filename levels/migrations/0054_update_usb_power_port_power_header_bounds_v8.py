...
def update_usb_power_port_power_header_bounds_v8(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0053_update_usb_power_port_power_header_bounds_v7"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_power_header_bounds_v8),
    ]
