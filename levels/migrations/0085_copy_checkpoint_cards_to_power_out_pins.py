...
def copy_checkpoint_cards_to_power_out_pins(apps, schema_editor):
    ...
    dest_lesson, _ = Lesson.objects.get_or_create(
        system=system,
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0084_update_brain_chip_quiz_question"),
    ]

    operations = [
        migrations.RunPython(copy_checkpoint_cards_to_power_out_pins),
    ]
