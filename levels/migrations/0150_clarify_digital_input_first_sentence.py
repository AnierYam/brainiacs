...
OLD_BODY = (
    ...
    "On Arduino, DIGITAL pins (2-13) are used to read ***controllers with two states output (HIGH / LOW)*** "
    "like push buttons or switches."
)
NEW_BODY = (
    "Digital input to the pins from the controller reads only two states: High (ON) or LOW (OFF).\n\n"
    "On Arduino, DIGITAL pins (2-13) are used to read ***controllers with two states output (HIGH / LOW)*** "
    "like push buttons or switches."
)
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0149_replace_output_with_input_in_digital_output_intro"),
    ]
