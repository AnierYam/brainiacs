...
def restore_usb_power_port_hotspots_v1(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0016_update_usb_power_port_overlay_svg"),
    ]

    operations = [
        migrations.RunPython(restore_usb_power_port_hotspots_v1),
    ]
