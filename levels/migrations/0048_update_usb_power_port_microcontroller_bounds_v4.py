...
def update_usb_power_port_microcontroller_bounds_v4(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0047_update_usb_power_port_microcontroller_bounds_v3"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_microcontroller_bounds_v4),
    ]
