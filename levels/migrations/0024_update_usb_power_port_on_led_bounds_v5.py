...
def update_usb_power_port_on_led_bounds_v5(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0023_update_usb_power_port_on_led_bounds_v4"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v5),
    ]
