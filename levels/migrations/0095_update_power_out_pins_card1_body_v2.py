...
def update_power_out_pins_card1_body_v2(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0094_update_power_out_pins_card1_body_hint"),
    ]

    operations = [
        migrations.RunPython(update_power_out_pins_card1_body_v2),
    ]
