...
def update_usb_power_port_l_led_bounds_v6(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0039_update_usb_power_port_l_led_bounds_v5"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_l_led_bounds_v6),
    ]
