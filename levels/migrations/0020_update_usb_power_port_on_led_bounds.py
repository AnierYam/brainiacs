...
def update_usb_power_port_on_led_bounds(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0019_update_usb_power_port_hotspots_text_bounds"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds),
    ]
