...
def update_usb_power_port_on_led_bounds_v10(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0028_update_usb_power_port_on_led_bounds_v9"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v10),
    ]
