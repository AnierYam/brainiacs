...
def update_usb_power_port_l_led_bounds_v7(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0040_update_usb_power_port_l_led_bounds_v6"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_l_led_bounds_v7),
    ]
