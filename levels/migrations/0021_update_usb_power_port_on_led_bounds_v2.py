...
def update_usb_power_port_on_led_bounds_v2(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("levels", "0020_update_usb_power_port_on_led_bounds"),
    ]

    operations = [
        migrations.RunPython(update_usb_power_port_on_led_bounds_v2),
    ]
